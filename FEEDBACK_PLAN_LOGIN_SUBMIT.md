...
*(Với cách cấu hình này, file `src/lib/http.ts` của bạn sẽ rất sạch, không cần viết logic If/Else kiểm tra môi trường.)*
...
Trong tài liệu kỹ thuật ban đầu (`tradingbot_doc.md` Mục 5.2 và 5.3), kiến trúc backend định nghĩa 2 endpoint rời:
1. `POST /bot/create` 
